...
requested_at_utc: 2026-05-12T23:15:00Z
...
- Block stale NAV or stale pricing-date leakage in executive/action sections.
...
## Known follow-up
The full ETF-style robust layered close-price discovery model is now tracked in NEXT_ACTIONS and is not yet fully ported to weekly-index. This run should validate the current upgraded report-consumption and validation layer first.
